...
def test_GET_request_for_homepage(client):
    ...
    homepage = client.get('/')  #ALERT: `TypeError: __init__() got an unexpected keyword argument 'as_tuple'`
...
def test_404_page(client):
    ...
    nonexistent_page = client.get('/404')  #ALERT: `TypeError: __init__() got an unexpected keyword argument 'as_tuple'`
