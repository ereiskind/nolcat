...
def test_upload_COUNTER_reports(client, header_value, engine, COUNTERData_relation, caplog):
...
def test_harvest_SUSHI_statistics(engine, most_recent_month_with_usage, client, header_value, caplog):
