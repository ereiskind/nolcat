...
#ToDo: Should the rendering of `ingest_usage.harvest_SUSHI_statistics()` before the form submission, which includes a field with a variable drop-down, be a test?
