...
def test_view_lists_homepage(client):
    ...
    #with open(Path(*Path(__file__).parts[0:Path(__file__).parts.index('nolcat')+1], 'nolcat', 'view_lists', 'templates', 'view_lists', 'index.html'), 'br') as HTML_file:
