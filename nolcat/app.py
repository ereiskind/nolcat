...
def configure_logging(app):
    ...
    logging.getLogger('sqlalchemy.engine.base.Engine').setLevel(logging.WARNING)  # Logger `sqlalchemy.engine` includes log statements from modules `sqlalchemy.engine.base.Engine` and `sqlalchemy.engine.base.OptionEngine`, which are repeats of one another
