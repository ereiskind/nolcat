...
class RawCOUNTERReport:
    ...
    def perform_deduplication_matching(self, normalized_resource_data=None):
        ...
        #ALERT: At this point, an error is thrown (complete stack trace below); the CPU Maximum Frequency spikes to 100%+ and Used Physical Memory begins to rise, but neither rises steeply nor gets very high
        '''
        INTERNALERROR> Traceback (most recent call last):
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\main.py", line 269, in wrap_session
        INTERNALERROR>     session.exitstatus = doit(config, session) or 0
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\main.py", line 323, in _main
        INTERNALERROR>     config.hook.pytest_runtestloop(session=session)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_hooks.py", line 265, in __call__
        INTERNALERROR>     return self._hookexec(self.name, self.get_hookimpls(), kwargs, firstresult)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_manager.py", line 80, in _hookexec
        INTERNALERROR>     return self._inner_hookexec(hook_name, methods, kwargs, firstresult)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_callers.py", line 60, in _multicall
        INTERNALERROR>     return outcome.get_result()
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_result.py", line 60, in get_result
        INTERNALERROR>     raise ex[1].with_traceback(ex[2])
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_callers.py", line 39, in _multicall
        INTERNALERROR>     res = hook_impl.function(*args)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\main.py", line 348, in pytest_runtestloop
        INTERNALERROR>     item.config.hook.pytest_runtest_protocol(item=item, nextitem=nextitem)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_hooks.py", line 265, in __call__
        INTERNALERROR>     return self._hookexec(self.name, self.get_hookimpls(), kwargs, firstresult)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_manager.py", line 80, in _hookexec
        INTERNALERROR>     return self._inner_hookexec(hook_name, methods, kwargs, firstresult)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_callers.py", line 55, in _multicall
        INTERNALERROR>     gen.send(outcome)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\warnings.py", line 100, in pytest_runtest_protocol
        INTERNALERROR>     yield
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\contextlib.py", line 120, in __exit__
        INTERNALERROR>     next(self.gen)
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\warnings.py", line 72, in catch_warnings_for_item
        INTERNALERROR>     ihook.pytest_warning_recorded.call_historic(
        INTERNALERROR>   File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_hooks.py", line 274, in call_historic
        INTERNALERROR>     self._call_history.append((kwargs or {}, result_callback))
        INTERNALERROR> MemoryError

        Traceback (most recent call last):
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\runpy.py", line 193, in _run_module_as_main
            return _run_code(code, main_globals, None,
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\runpy.py", line 86, in _run_code
            exec(code, run_globals)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pytest\__main__.py", line 5, in <module>
            raise SystemExit(pytest.console_main())
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\config\__init__.py", line 185, in console_main
            code = main()
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\config\__init__.py", line 162, in main
            ret: Union[ExitCode, int] = config.hook.pytest_cmdline_main(
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_hooks.py", line 265, in __call__
            return self._hookexec(self.name, self.get_hookimpls(), kwargs, firstresult)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_manager.py", line 80, in _hookexec
            return self._inner_hookexec(hook_name, methods, kwargs, firstresult)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_callers.py", line 60, in _multicall
            return outcome.get_result()
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_result.py", line 60, in get_result
            raise ex[1].with_traceback(ex[2])
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_callers.py", line 39, in _multicall
            res = hook_impl.function(*args)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\main.py", line 316, in pytest_cmdline_main
            return wrap_session(config, _main)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\main.py", line 304, in wrap_session
            config.hook.pytest_sessionfinish(
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_hooks.py", line 265, in __call__
            return self._hookexec(self.name, self.get_hookimpls(), kwargs, firstresult)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_manager.py", line 80, in _hookexec
            return self._inner_hookexec(hook_name, methods, kwargs, firstresult)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\pluggy\_callers.py", line 55, in _multicall
            gen.send(outcome)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\terminal.py", line 823, in pytest_sessionfinish
            self.summary_stats()
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\terminal.py", line 1047, in summary_stats
            (parts, main_color) = self.build_summary_stats_line()
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\terminal.py", line 1199, in build_summary_stats_line
            return self._build_normal_summary_stats_line()
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\terminal.py", line 1213, in _build_normal_summary_stats_line
            reports = self._get_reports_to_display(key)
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\terminal.py", line 1204, in _get_reports_to_display
            return [x for x in reports if getattr(x, "count_towards_summary", True)]
        File "C:\Users\ereiskind\AppData\Local\Programs\Python\Python38-32\lib\site-packages\_pytest\terminal.py", line 1204, in <listcomp>
            return [x for x in reports if getattr(x, "count_towards_summary", True)]
        MemoryError
        '''
