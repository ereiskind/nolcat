...
#TEST: temp
log.error(f"'nolcat/nolcat/nolcat_glue_job.py' `log` (type {type(log)}):\n{log}")
log.error(f"'nolcat/nolcat/nolcat_glue_job.py' `log.name` (type {type(log.name)}):\n{log.name}")
log.error(f"'nolcat/nolcat/nolcat_glue_job.py' `log.parent` (type {type(log.parent)}):\n{log.parent}")
log.error(f"'nolcat/nolcat/nolcat_glue_job.py' `log.propagate` (type {type(log.propagate)}):\n{log.propagate}")
log.error(f"'nolcat/nolcat/nolcat_glue_job.py' `log.handlers` (type {type(log.handlers)}):\n{log.handlers}")
log.error(f"'nolcat/nolcat/nolcat_glue_job.py' `log.getChildren()` (type {type(log.getChildren())}):\n{log.getChildren()}")
#TEST: end temp
