...
def view_lists_homepage(list):
    ...
    df['View Record Details'] = df['ID'].apply(lambda cell_value: cell_value)  # f"url_for('view_lists.view_list_record', list='{list}', PK={df['ID'].apply(lambda cell_value: cell_value)})"
    df['Edit'] = df['ID'].apply(lambda cell_value: cell_value)  # f"url_for('view_lists.edit_list_record', list='{list}', PK={df['ID'].apply(lambda cell_value: cell_value)})"
