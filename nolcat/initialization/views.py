...
def collect_FY_and_vendor_data():
    ...
    if request.method == 'GET':
        ...
        #TEST: temp
        with open(Path(r'/tmp/pytest-of-root/pytest-12/test_collect_FY_and_vendor_dat0/annualStatistics_relation.csv')) as f:
            for line in f:
        ...
        annualStatistics_dataframe.reset_index()
        ...
        annualStatistics_dataframe.set_index(['fiscal_year_ID', 'question'])
